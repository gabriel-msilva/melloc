...
subtitle: Set up an interactive Python environment for development in Visual Studio Code
...
![IPython session in terminal](./thumbnail.png)
...
@fig-ipython-history and @fig-ipython-tab-completion show auto-completion features of IPython that allows you to type less.

![Command history cache in IPython. You can navigate the history with arrows keys or get completion for previous commands.](./figures/ipython-history.png){#fig-ipython-history}

![Tab completion in IPython. Start typing and press <kbd>Tab</kbd> to get options of objects or methods that match the text.](./figures/ipython-tab-completion.png){#fig-ipython-tab-completion fig-align="center"}
...
This makes _all_ the difference.
...
@fig-python-environment shows how to select the interpreter from this environment when working on your files.
You can also press <kbd>F1</kbd> (or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd>) and search _Python: Select Interpreter_.

![Selecting the Python interpreter in VS Code.](./figures/python-environment.png){#fig-python-environment}

Now set launch arguments to open an IPython session instead of the default Python terminal.
Open VS Code settings file:

1. Press <kbd>F1</kbd> (or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd>)
2. Go to _Preferences: Open User Settings (JSON)_
3. Set `python.terminal.launchArgs` to run IPython:
...
If you don't have one yet (usually at _~/.ipython/profile_default/ipython_config.py_), you may create it with
...
1. Open VS Code settings: <kbd>F1</kbd> > _Preferences: Open User Settings (JSON)_
