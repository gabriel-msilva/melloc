...
fig_links <- list(
  static = paste0(
    "figures/static/",
    c(
      sierpinski_triangle = "sierpinski-triangle.png",
      sierpinski_steps = "sierpinski-steps.png",
      mandelbrot_bw = "mandelbrot-bw.png",
      mandelbrot_colored = "mandelbrot-colored.png",
      mandelbrot_smoothing = "mandelbrot-smoothing.png",
      mandelbrot_zoom = "mandelbrot-zoom.png",
      julia_set = "julia-set.png"
    )
  ),
  animated = paste0(
    "figures/animated/",
    c(
      julia_circumference = "julia-circumference.gif",
      julia_segment = "julia-segment.gif",
      julia_zoom = "julia-zoom.gif",
      mandelbrot_zoom = "mandelbrot-zoom.gif",
    )
  )
)
